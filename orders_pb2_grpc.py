...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetOrderStatus = channel.unary_unary(
                ...
                response_deserializer=orders__pb2.OrderStatusResponse.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetOrderStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=orders__pb2.OrderStatusResponse.SerializeToString,
            ),
    }
...
class OrderService(object):
    ...
    def GetOrderStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            orders__pb2.OrderStatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
